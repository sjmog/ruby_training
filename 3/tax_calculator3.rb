...
def fraction_of_people_who_will_pay(base_tax_rate=0,low_tax_rate=0.2,med_tax_rate=0.4,high_tax_rate=0.5,stu_loan_rate=0.05,nat_ins_rate=0.05)
  (1-(base_tax_rate+ 0.5*low_tax_rate+0.3*med_tax_rate+0.1*high_tax_rate+stu_loan_rate+nat_ins_rate)).round(2)
end
...
def government_revenue(income=0,base_tax_rate=0,low_tax_rate=0.2,med_tax_rate=0.4,high_tax_rate=0.5,stu_loan_rate=0.05,nat_ins_rate=0.05,pop_size=1000000)
  (pop_size*fraction_of_people_who_will_pay(base_tax_rate,low_tax_rate,med_tax_rate,high_tax_rate,stu_loan_rate,nat_ins_rate)*government_revenue_per_head(income,base_tax_rate,low_tax_rate,med_tax_rate,high_tax_rate,stu_loan_rate,nat_ins_rate)).round(0)
end
